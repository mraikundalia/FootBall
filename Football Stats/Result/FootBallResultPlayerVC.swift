...
//            string = UserDefaults.standard.integer(forKey: "registerid")
    ...
    let verify_param = ["storedProcedureName":"getMatchResult_player","input1":str2 as Any ,"input2":gameidint as Any,"input3":playername] as [String : Any]
    ...
    //            string = UserDefaults.standard.integer(forKey: "registerid")
        ...
        let verify_param = ["storedProcedureName":"update_MatchResult_player","input1":str2 as Any ,"input2":gameid1 as Any,"input3":playername,"input4":myInt1 as Any,"input5":btngoals.currentTitle!,"input6":btnasists.currentTitle!,"input7":txtplayernote.text as Any] as [String : Any]
               let signin_headers: HTTPHeaders = ["x-api-key":"CODEX@123"]
         AF.request(GlobalConstants.ApiURL, method: .post, parameters: verify_param, encoding: URLEncoding.httpBody, headers:signin_headers).responseJSON {
                     response in
