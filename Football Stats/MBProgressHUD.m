...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opaque = NO;
        self.backgroundColor =[UIColor colorWithRed:220.0f/255 green:220.0f/255 blue:220.0f/255 alpha:0.4];
...
- (void)setupLabels
{
	...
	label.textColor =  [UIColor blackColor];          //[UIColor colorWithRed:59.0f/255 green:136.0f/255 blue:253.0f/255 alpha:1.0];
    label.font =[UIFont fontWithName:@"Montserrat-SemiBold" size:14];
...
- (void)updateIndicators {
	...
	if (mode == MBProgressHUDModeIndeterminate &&  !isActivityIndicator) {
		...
		self.indicator = MB_AUTORELEASE([[CDActivityIndicatorView alloc] initWithImage:[UIImage imageNamed:@"load"]]);
